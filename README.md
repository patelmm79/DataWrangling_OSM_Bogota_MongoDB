I explored, cleansed, and analysed OpenStreetMap data for Bogota, Colombia using MongoDB (via Python).  I selected the city of Bogotá for a number of reasons. First of all, I know the city
